...
const CardIndependent: React.FC<Type> = ({ isEditing }) => {
  return (
    <>
      <li className="border-[#0068FF] border-[2px] text-black bg-white rounded-[6px] w-[122.41px] h-[94.5px] p-[5.9px] flex flex-col justify-between">
        ...
        <div className="flex flex-col items-center h-[38.4px] w-full pt-[8px] justify-between">
          <h1 className="text-[#0068FF] text-[13.86px] font-semibold">
            {isEditing}
          </h1>
