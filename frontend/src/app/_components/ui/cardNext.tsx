...
const CardNext: React.FC<Type> = ({ handleNext, no, start }) => {
  return (
    <>
      <div className="border-[0.7px] rounded-[6px] w-[122.41px] max-[400px]:w-[115px] max-[380px]:w-[110px] max-[370px]:w-[105px] max-[365px]:w-[103px] h-[93.06px] p-[5.9px] flex flex-col gap-[11px]">
