      ...
      <div className=" overflow-y-scroll h-full">
        ...
        <div className="flex flex-col items-center w-screen pt-[22px] px-[15.5px]">
          ...
          <p className="text-[12px] w-full pt-[21px] px-[5px] text-justify leading-[14.4px]">
            ...
            not. It is easy, clear and a bit surprising. The system is
            absolutely safe and spam free. Our team of editors curates the
            content and make sure you don’t click where you should not.
          </p>
          <Link
            href={"/videos"}
            className="border-[1.5px] border-white  rounded-[3.2px] text-[14.91px] pt-[3.2px] pb-[1.3px] px-[2.13px] my-[43px] "
          >
            ALL VIDEOS
          </Link>
        </div>
